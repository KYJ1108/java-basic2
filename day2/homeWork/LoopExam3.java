...
손흥민은 투입과 동시에 그리고 5분마다 골을 넣을 수 있는 능력을 가지고 있다. 75??80 85 90 // 74 79 84 89

바로 골
만약 80분에 투입이 되면 80분에 곧을 넣게되고 85분에 골을 넣음으로서 동점이 가능하게 된다.
...
*/
        ...
        for (int time = 0; time < 90-74; time ++){
            if (time % 5 ==0) {
                score += 1;
            }
        }
