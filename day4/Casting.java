...
public class Casting {
    public static void main(String[] args) {
        ...
        int c =  (int)3.14; // 형변환 X => double이 int로 바뀌려면 소수점 떼야함(수동형변환)
        ...
        Cat c1 = new Cat(); // 고양이
        c1.breath(); // 숨쉬기
        Animal a1 = new Animal(); // 동물
        a1.breath();

        Animal a2 = c1; // 하위타입이 상위타입으로 모습을 바꾸는 건 괜찮아서 자동 형변환이 일어남. (고양이가 야옹안한다고 약속하면 동물이기에 문제 없음.)
        a2.breath();
        a2.eat();
