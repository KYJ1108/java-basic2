...
public class AccountExam {
    public static void main(String[] args) {
        ...
        int mon = a1.withdraw(400); // 인출
        //System.out.println(money); // 400

        int remainder = a1.getRemainder(); // 잔액
        //System.out.println(remainder); // 5600

        mon = a1.withdraw(1400);
        ...
        a2.deposit (2000); // 2000원을 예금했습니다.
        a2.deposit (4000); // 4000원을 예금했습니다.
